...
DIRTES="/RSYNC/IBMFARM01/TESOURARIA" ## NFS para o IBMFARM01k#2020
...
SRVMIDAS="10.224.28.131" ## IP do servidor de HOMOLOGACAO do Midas
USRMIDAS="midas" ## Usuario remoto de HOMOLOGACAO do Midas
