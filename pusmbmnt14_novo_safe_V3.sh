...
if [ $? -eq 0 ]; then
  ...
  if [ $? -eq 0 ]; then
    if [ `ls /LOCAL_STATX/GARANTIA/SAFE_FAI/PR* 2>/dev/null | wc -l` -gt 0 ]; then
   	  /usr/bin/rsync -v /LOCAL_STATX/GARANTIA/SAFE_FAI/PR* /smbfs/SAFE_FAI/integracao/001 >>$log 2>&1 && \
    ...
    if [ `ls /LOCAL_STATX/GARANTIA/SAFE_FAI/TR* 2>/dev/null | wc -l` -gt 0 ]; then
      /usr/bin/rsync -v /LOCAL_STATX/GARANTIA/SAFE_FAI/TR* /smbfs/SAFE_FAI/integracao/002  >>$log 2>&1 && \
    ...
    if [ `ls /LOCAL_STATX/GARANTIA/SAFE_FAI/VR* 2>/dev/null | wc -l` -gt 0 ]; then
      /usr/bin/rsync -v /LOCAL_STATX/GARANTIA/SAFE_FAI/VR* /smbfs/SAFE_FAI/integracao/003 >>$log 2>&1 && \
    ...
    if [ `ls /LOCAL_STATX/GARANTIA/SAFE_FAI/TG*SOL* 2>/dev/null | wc -l` -gt 0 ]; then
      /usr/bin/rsync -v /LOCAL_STATX/GARANTIA/SAFE_FAI/TG*SOL* /smbfs/SAFE_FAI/integracao/010 >>$log 2>&1 && \
    ...
    if [ `ls /LOCAL_STATX/GARANTIA/SAFE_FAI/MAPFRESOL* 2>/dev/null | wc -l` -gt 0 ]; then
      /usr/bin/rsync -v /LOCAL_STATX/GARANTIA/SAFE_FAI/MAPFRESOL* /smbfs/SAFE_FAI/integracao/012 >>$log 2>&1 && \
